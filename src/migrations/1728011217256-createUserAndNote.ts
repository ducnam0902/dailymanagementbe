...
export class CreateUserAndNote1728011217256 implements MigrationInterface {
    name = 'CreateUserAndNote1728011217256'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "note" ("id" SERIAL NOT NULL, "note" character varying NOT NULL DEFAULT '', "isCompleted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "type" "public"."note_type_enum" NOT NULL, "userId" integer, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`);
