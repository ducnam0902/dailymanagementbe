...
export class CreateUser1726632708972 implements MigrationInterface {
    name = 'CreateUser1726632708972'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "note" ("id" SERIAL NOT NULL, "note" character varying NOT NULL DEFAULT '', "isCompleted" boolean NOT NULL DEFAULT false, "date" date NOT NULL DEFAULT now(), "type" "public"."note_type_enum" NOT NULL, "userId" integer, CONSTRAINT "PK_96d0c172a4fba276b1bbed43058" PRIMARY KEY ("id"))`);
